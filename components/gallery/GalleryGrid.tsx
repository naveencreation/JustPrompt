...
export function GalleryGrid({
  ...
  return (
    <>
      <div className={`columns-1 gap-6 sm:columns-2 md:columns-3 lg:columns-4 xl:columns-4 2xl:columns-4 sm:gap-8 md:gap-10 transition-[filter] duration-200 ${activeLightbox ? "pointer-events-none brightness-75" : ""}`}>
